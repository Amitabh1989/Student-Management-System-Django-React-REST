...
export default function EditStudentModal({ student, closeModal }) {
    ...
    const handleEditStudent = async () => {
        console.log("Handling Course data : ", formData)
        try {
            const response = await editStudents(student.id, formData);
            console.log("Response from editStudents:", response);
                    ...
                    <div className="relative bg-white rounded-lg shadow dark-bg-gray-700">
                        ...
                        <div className="px-6 py-6 lg-px-8">
                            ...
                            <form className="space-y-6" action="#">
                                ...
                                <div>
                                    <Button variant="filled" onClick={handleEditStudent}>Submit</Button>
                                </div>
                            </form>
                        </div>
                    </div>
